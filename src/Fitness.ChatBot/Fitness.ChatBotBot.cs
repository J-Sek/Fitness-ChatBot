...
namespace Fitness.ChatBot
{
    ...
    /// </summary>
    public class Fitness.ChatBotBot : IBot
    {
    ...
    /// </summary>
    public Fitness.ChatBotBot(BotServices services, UserState userState, ConversationState conversationState, ILoggerFactory loggerFactory)
        {
